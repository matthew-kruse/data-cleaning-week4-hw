...
The columns of the results.txt file are the means of the following variables, broken down by the activity and subject on the row in the results file:
```
...
The source data for this project has the following documentation
